...
> **web-doc-resolver UI layer** — design system, component specs, and token architecture for the resolver workspace PWA.
> Data-dense workspace tool, not a chat app. Anti-slop, developer-first.

## Overview

`cli/ui/` contains the design system for the web-doc-resolver Next.js PWA. Covers design tokens, component specifications, Storybook config, and integration with Google Stitch for screen generation. All UI work maps to GitHub epic issues #69–#74.
