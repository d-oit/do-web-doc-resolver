...
class TestIsUrl:
    ...
    def test_valid_urls(self):
        ...
        assert is_url("https://docs.rs/tokio") == True
...
class TestResolveWithFirecrawl:
    ...
    @patch('scripts.resolve.Firecrawl')
    ...
    def test_rate_limit_fallback(self, mock_mistral, mock_firecrawl_class):
        ...
        mock_mistral.return_value = {'source': 'mistral-browser', 'content': 'Mistral content'}
