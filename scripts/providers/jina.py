...
from scripts.utils.async_http import get_async_client
from scripts.utils.async_http import is_safe_url as async_is_safe_url

logger = logging.getLogger(__name__)


async def resolve_with_jina_async(url: str, max_chars: int = MAX_CHARS) -> ResolvedResult | None:
    """Async version of Jina resolver using httpx."""
...
def resolve_with_jina(url: str, max_chars: int = MAX_CHARS) -> ResolvedResult | None:
    """Sync version of Jina resolver using httpx (backward compatible)."""
