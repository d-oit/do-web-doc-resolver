...
async def resolve_with_exa_mcp_async(
    ...
    """Async version of Exa MCP resolver using httpx."""
...
async def resolve_with_exa_async(query: str, max_chars: int = MAX_CHARS) -> ResolvedResult | None:
    """Async version of Exa resolver."""
