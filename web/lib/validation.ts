...
const PRIVATE_IP_RANGES = [
  ...
  /^::1$/,
  /^::$/,
  /^::ffff:(127\.|10\.|172\.(1[6-9]|2[0-9]|3[0-1])\.|192\.168\.|169\.254\.|100\.(6[4-9]|[7-9][0-9]|1[01][0-9]|12[0-7])\.|0\.0\.0\.0)/i,
  /^::ffff:[0-9a-f]{1,4}:[0-9a-f]{1,4}/i, // General IPv4-mapped IPv6 (hex)
  /^fc/i,
  /^fd/i,
  /^fe80/i,
  /^2001:db8/i,
