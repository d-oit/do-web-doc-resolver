...
export default function ProfileCombobox<T extends string>({ value, options, onChange }: ProfileComboboxProps<T>) {
  ...
  return (
    <div className="relative">
      <button
        ref={buttonRef}
        className="w-full bg-[#141414] border-2 border-[#333] px-2 py-2 text-[13px] text-[#e8e6e3] focus:border-[#00ff41] min-h-[44px] flex items-center justify-between focus-visible:outline-2 focus-visible:outline-[#00ff41] focus-visible:outline-offset-2 focus-visible:outline-none"
