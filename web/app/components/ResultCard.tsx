  ...
  return (
    ...
    >
      <header className="flex flex-col gap-1">
        {result.url ? (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-[#00ff41] text-[15px] hover:underline focus-visible:outline-2 focus-visible:outline-[#00ff41] focus-visible:outline-offset-2 focus-visible:outline-none"
          >
            {result.title}
          </a>
        ) : (
      ...
      <footer className="flex flex-wrap gap-2 text-[11px]">
        <button
          onClick={handleCopy}
          className="px-3 py-2 border-2 border-[#333] hover:border-[#00ff41] focus-visible:outline-2 focus-visible:outline-[#00ff41] focus-visible:outline-offset-2 focus-visible:outline-none"
        >
        ...
        {onHelpfulToggle && (
          <button
            ...
            } focus-visible:outline-2 focus-visible:outline-[#00ff41] focus-visible:outline-offset-2 focus-visible:outline-none`}
