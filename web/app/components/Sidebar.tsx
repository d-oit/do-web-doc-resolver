      ...
      <div className="flex lg:hidden w-full p-4 items-center justify-between border-b-2 border-border-muted min-h-[44px]">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="text-[11.5px] text-text-muted hover:text-[#ff4444] focus:text-[#ff4444] font-bold min-h-[30px] px-2 flex items-center focus-visible:outline-2 focus-visible:outline-accent focus-visible:outline-offset-2"
