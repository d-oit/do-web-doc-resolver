  ...
  return (
    <main className="min-h-screen bg-background text-foreground font-mono flex items-center justify-center p-8">
      <div className="max-w-md w-full space-y-4">
        ...
        <Link
          href="/"
          className="inline-block bg-accent text-background px-4 py-2 text-[13px] font-bold hover:bg-[#00cc33] min-h-[44px] focus-visible:outline-2 focus-visible:outline-accent focus-visible:outline-offset-2"
        >
          Go home
        </Link>
      </div>
